"""
MÉTRICAS FINALES — CatBoost global — 6_24h
...
VARIABLES = ['map_min', 'hr_media', 'lactato_max', 'diuresis_ml_kg_6h', 'pf_min', 'spo2_min', 'rr_max', 'ph_min', 'sofa_max', 'hemoglobina_min', 'glucemia_min', 'temp_min']
