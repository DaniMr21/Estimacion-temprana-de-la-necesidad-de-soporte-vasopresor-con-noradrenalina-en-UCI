"""
BASELINE COMPLETO — v4 (6-24h)
6 algoritmos × 3 subgrupos (Global, Sépticos, No Sépticos)
Set final v4: 12 variables.

Grids recortados respecto al baseline original v4 según los best_params
observados, manteniendo los rangos en los que caían los óptimos.

Salidas:
  - tablas/baseline_completo_v4.csv  (resumen por subgrupo y algoritmo)
  - Salida en consola con detalle por fold.
"""
...
def construir_pipelines_y_grids():
    ...
    # 1. Regresión Logística (grid completo, es rápido)
...
# ── ENTRENAR TODOS LOS ALGORITMOS PARA UN SUBGRUPO ────────────────────────────
...
def main():
    print("=" * 72)
    print("BASELINE COMPLETO — v4 (6-24h)  |  6 algoritmos × 3 subgrupos")
    print("=" * 72)
    ...
    if len(df_res):
        ...
        ruta = os.path.join(CARPETA_TABLAS, 'baseline_completo_v4.csv')
