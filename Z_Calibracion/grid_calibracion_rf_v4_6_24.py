"""
Búsqueda automática de configuración de calibración para Random Forest v4 (6-24h).

Objetivo:
  - Mantener fijo el modelo RF final.
...
CARPETA_SALIDA = os.path.join(DIR_SCRIPT, 'salida_calibracion_rf_grid')
...
def main():
    print('=' * 70)
    print('BÚSQUEDA DE CALIBRACIÓN — RANDOM FOREST v4 6-24h')
    print('=' * 70)
    ...
    ruta_metricas = os.path.join(CARPETA_TABLAS, 'metricas_rf_grid_calibracion.csv')
    ruta_predicciones = os.path.join(CARPETA_TABLAS, 'predicciones_rf_grid_calibracion.csv')
    ruta_resumen = os.path.join(CARPETA_TABLAS, 'resumen_rf_grid_calibracion.csv')
