"""
Búsqueda automática de configuración de calibración para CatBoost v4l (12-48h).

Objetivo:
  - Mantener fijo el modelo CatBoost final de la ventana larga.
...
CARPETA_SALIDA = os.path.join(DIR_SCRIPT, 'salida_calibracion_catboost_v4l_grid')
...
# Hiperparámetros conservadores del grid previo de la ventana larga.
# En tu SHAP v4l ganó:
# iterations=500, depth=7, learning_rate=0.01, l2_leaf_reg=5, bagging_temperature=0.
...
def main():
    print('=' * 70)
    print('BÚSQUEDA DE CALIBRACIÓN — CATBOOST v4l 12-48h')
    print('=' * 70)
    ...
    ruta_metricas = os.path.join(CARPETA_TABLAS, 'metricas_catboost_v4l_grid_calibracion.csv')
    ruta_predicciones = os.path.join(CARPETA_TABLAS, 'predicciones_catboost_v4l_grid_calibracion.csv')
    ruta_resumen = os.path.join(CARPETA_TABLAS, 'resumen_catboost_v4l_grid_calibracion.csv')
    ...
    print('\nCALIBRACIÓN CATBOOST v4l COMPLETADA')
