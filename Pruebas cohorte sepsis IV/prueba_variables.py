...
RUTA_SALIDA = os.path.join(os.path.dirname(__file__), 'importancia_variables_rf_v4.txt')

# Cargar
df = pd.read_csv(RUTA)
df = df.dropna(subset=['pf_max'])

# Variables (las mismas que usas)
variables = [
...
# RANDOM FOREST con mejores params (según tu salida)
...
with open(RUTA_SALIDA, 'w', encoding='utf-8') as f:
    f.write("IMPORTANCIA VARIABLES RF\n")
    f.write("="*50 + "\n\n")
