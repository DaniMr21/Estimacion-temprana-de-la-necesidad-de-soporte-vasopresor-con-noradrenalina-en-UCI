...
ENTRADA = os.path.join(CARPETA, 'dataset_final_v4.csv')
SALIDA  = os.path.join(CARPETA, 'definitivo_v4.csv')
...
#  - Binarias (tiene_sepsis, ventilacion_invasiva_6h): 0/1, winsorizar no tiene sentido.
