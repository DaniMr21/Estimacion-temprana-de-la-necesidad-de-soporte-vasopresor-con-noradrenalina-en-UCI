"""
Comparación empírica de calibración — Medio_6_24 XGB
=====================================================
...
Requiere:
  - modelo_Medio_6_24_XGB.pkl  (en la misma carpeta que este script)
  - definitivo_v4.csv         (ruta configurada abajo)
"""
...
fig.suptitle(
    'Comparación empírica calibración OOF — XGB | Medio_6_24',
