...
\addlinespace
9 & Abril (2.\textsuperscript{a} q.) & Propón cómo organizar la configuración de ventanas Corto\_3\_12, Medio\_6\_24 y Largo\_12\_48 para no duplicar rutas y variables en varios scripts. & Organización del código \\
\addlinespace
...
\addlinespace
13 & Abril (2.\textsuperscript{a} q.) & Cómo plantear un sistema de checkpoint que lea el CSV de resultados y omita combinaciones ventana-modelo ya evaluadas. & Reanudación de experimentos \\
\addlinespace
...
\addlinespace
24 & Abril (2.\textsuperscript{a} q.) & Ayúdame a transformar importancias SHAP ya calculadas en una tabla o heatmap comparativo por variable, algoritmo y ventana. & Comparativa de explicabilidad \\
\addlinespace
...
\addlinespace
33 & Mayo (1.\textsuperscript{a} q.) & Añade comprobaciones de forma para verificar que los datos, los valores SHAP y los nombres de variables tienen dimensiones compatibles antes de graficar. & Depuración SHAP \\
\addlinespace
...
\addlinespace
41 & Mayo (2.\textsuperscript{a} q.) & Revisa una función validar\_csv\_paciente que comprueba columnas obligatorias, tipos numéricos, escala de FiO2 y valores plausibles antes de aplicar el modelo. & Robustez del dashboard \\
\addlinespace
...
\addlinespace
44 & Mayo (2.\textsuperscript{a} q.) & Ayúdame a convertir resultados ya calculados en una tabla de hiperparámetros finales para XGBoost, LightGBM, Random Forest, CatBoost, regresión logística y Naive Bayes. & Documentación de entrenamiento \\
\addlinespace
45 & Mayo (2.\textsuperscript{a} q.) & Ayúdame a transformar resultados estadísticos ya obtenidos en una tabla resumen de variables significativas por regresor. & Resultados \\
\addlinespace
46 & Mayo (2.\textsuperscript{a} q.) & Documenta en el código que los valores SHAP pertenecen al modelo base y que la calibración solo transforma la probabilidad final. & Claridad metodológica \\
\addlinespace
