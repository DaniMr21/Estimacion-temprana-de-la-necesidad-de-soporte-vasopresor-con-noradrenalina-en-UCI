...
\begin{enumerate}
  \item \item Importar MIMIC-IV y eICU-CRD en una instancia local de PostgreSQL autorizada y ejecutar sobre ella las consultas SQL de extracción de cohortes.
