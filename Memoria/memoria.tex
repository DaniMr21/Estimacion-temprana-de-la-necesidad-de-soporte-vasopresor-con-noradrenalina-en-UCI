...
\noindent D. \nombreTutor, profesor del departamento de Informática, área de Lenguajes Informáticos.
...
\begin{abstract}
Aprendizaje automático, Dashboard, UCI, norepinefrina, noradrenalina. \ldots
\end{abstract}
...
\begin{abstract}
Machine Learning, Dashboard, ICU, norepinephrine.
\end{abstract}
