...
def preparar(df):
    ...
    variables_predictoras = [
        ...
        # Constantes vitales (chartevents, también ventana 0-3h)
    ...
    # 1 si el paciente inició noradrenalina entre las horas 3 y 12 desde el
    # ingreso, 0 en caso contrario.
    etiqueta = df['etiqueta_norad_3_12'].copy()
