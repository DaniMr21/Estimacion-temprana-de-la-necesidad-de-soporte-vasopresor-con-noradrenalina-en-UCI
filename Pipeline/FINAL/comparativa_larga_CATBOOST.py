...
RUTA_PKL   = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'MODELOS_ENTRENADOS', 'modelo_Largo_12_48_CAT.pkl')
ETIQUETA   = 'etiqueta_norad_12_48'
COLUMNA_ID = 'subject_id'
VARIABLES  = ['pf_min', 'temp_min', 'diuresis_ml_kg_12h', 'bicarbonato_min', 'rr_max', 'glucemia_min']
N_SPLITS   = 5
RANDOM_SEED = 42
...
print("="*70)
print(f"\nEl CATBOOST del Largo supera al SOFA en {(roc_auc_score(y, prob_oof) - auc_sofa)*100:.1f} puntos porcentuales de AUC-ROC.")