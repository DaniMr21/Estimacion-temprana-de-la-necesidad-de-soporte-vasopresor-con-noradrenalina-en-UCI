...
VARIABLES  = ['map_min', 'pf_min', 'diuresis_ml_kg_6h', 'hr_media', 'rr_max', 'glucemia_min', 'ventilacion_invasiva_6h']
N_SPLITS   = 5
RANDOM_SEED = 42
...
print(f"\nCATBOOST supera al SOFA en {(roc_auc_score(y, prob_oof_calibrada) - auc_sofa)*100:.1f} puntos porcentuales de AUC-ROC.")