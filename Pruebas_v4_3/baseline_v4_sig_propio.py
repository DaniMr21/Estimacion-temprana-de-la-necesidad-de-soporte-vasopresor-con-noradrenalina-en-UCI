...
VARIABLES_POR_MODELO = {
    'LR': [
        'gpt_max', 'pf_min', 'diuresis_ml_kg_6h', 'rr_max',
        'sofa_max', 'ph_min', 'hr_media', 'ventilacion_invasiva_6h',
    ],
    'RF': [
        'pf_min', 'map_min', 'diuresis_ml_kg_6h', 'rr_max', 'gpt_max',
        'spo2_min', 'ph_min', 'hr_media', 'glucemia_min',
        'ventilacion_invasiva_6h', 'gender',
    ],
    'XGB': [
        'pf_min', 'map_min', 'diuresis_ml_kg_6h', 'temp_min', 'hr_media',
        'ph_min', 'sofa_max', 'ventilacion_invasiva_6h', 'gender',
    ],
    'LGBM': [
        'map_min', 'pf_min', 'diuresis_ml_kg_6h', 'gpt_max', 'spo2_min',
        'ph_min', 'ventilacion_invasiva_6h', 'gender',
    ],
    'CAT': [
        'map_min', 'pf_min', 'diuresis_ml_kg_6h', 'hr_media', 'rr_max',
        'glucemia_min', 'ph_min', 'ventilacion_invasiva_6h', 'gender',
    ],
    'NB': [
        'gpt_max', 'pf_min', 'diuresis_ml_kg_6h', 'rr_max', 'temp_min',
        'ph_min', 'lactato_max', 'sofa_max', 'hr_media',
        'ventilacion_invasiva_6h', 'fio2_max',
    ],
}
