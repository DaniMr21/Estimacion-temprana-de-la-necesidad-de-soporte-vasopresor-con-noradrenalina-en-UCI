...
def calcular_shap_rf(predictores, etiqueta):
    ...
    plt.tight_layout()
    ruta_beeswarm = os.path.join(carpeta_figuras, 'shap_beeswarm_v4_2_corta.png')
    ...
    plt.tight_layout()
    ruta_bar = os.path.join(carpeta_figuras, 'shap_bar_v4_2_corta.png')
    ...
    ruta_tabla = os.path.join(carpeta_tablas, 'importancia_shap_v4_2_corta.csv')
