"""
BASELINE COMPLETO — v4l (12-48h)
6 algoritmos × 3 subgrupos (Global, Sépticos, No Sépticos)
Set final v4l: 14 variables.
...
def main():
    print("=" * 72)
    print("BASELINE COMPLETO — v4l (12-48h)  |  6 algoritmos × 3 subgrupos")
    print("=" * 72)
    ...
    print(f"\n{'='*72}")
    print(f"RESUMEN GLOBAL — v4l  (tiempo total: {t_total_h:.2f} h)")
    print(f"{'='*72}")
    ...
    if len(df_res):
        ...
        ruta = os.path.join(CARPETA_TABLAS, 'baseline_completo_v4l.csv')
