"""
Análisis SHAP — RF v4l (set trabajo, 15 variables).
"""
...
# ── CARGA ─────────────────────────────────────────────────────────────────────
print("=" * 65)
print("ANÁLISIS SHAP — RF v4l (15 variables)")
print("=" * 65)
...
plt.title(
    f'SHAP — Importancia global RF v4l\nAUC CV = {gs.best_score_:.4f}',
    fontsize=11
)

plt.tight_layout()

ruta_bar = os.path.join(CARPETA_FIGS, 'shap_summary_bar_v4l_rf.png')
...
plt.title('SHAP — Beeswarm RF v4l', fontsize=11)

plt.tight_layout()

ruta_bee = os.path.join(CARPETA_FIGS, 'shap_summary_beeswarm_v4l_rf.png')
...
ruta_dep = os.path.join(CARPETA_FIGS, 'shap_dependence_TOP3_v4l_rf.png')
...
ruta_tab = os.path.join(CARPETA_TABLAS, 'shap_importance_v4l_rf.csv')
