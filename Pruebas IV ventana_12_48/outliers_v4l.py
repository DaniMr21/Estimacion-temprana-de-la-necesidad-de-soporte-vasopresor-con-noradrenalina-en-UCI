...
ENTRADA = os.path.join(CARPETA, 'dataset_final_v4l.csv')
SALIDA  = os.path.join(CARPETA, 'definitivo_v4l.csv')
...
#  - Binarias (tiene_sepsis, ventilacion_invasiva_12h): 0/1, winsorizar no tiene sentido.
...
print(f"Prevalencia: {100*df['etiqueta_norad_12_48'].mean():.2f}%")
