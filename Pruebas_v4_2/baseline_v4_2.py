...
def preparar(df):
    ...
    # 1 si el paciente inició noradrenalina entre las horas 6 y 24 desde el
    # ingreso, 0 en caso contrario.
    etiqueta = df['etiqueta_norad_6_24'].copy()

    # subject_id para agrupar en CV (mismo paciente nunca en train y test).
...
def main():
    ...
    print("\n" + "--------------")
    print(f"RESUMEN FINAL — SET REDUCIDO (tiempo total: {tiempo_total_horas:.2f} h)")
    print("--------------")
    ...
    print()
    print("COMPARACIÓN con set completo (76 variables):")
    print("  RF   completo: 0.6992 ± 0.0134")
    print("  CAT  completo: 0.6950 ± 0.0118")
    print("  LR   completo: 0.6921 ± 0.0162")
    print("  XGB  completo: 0.6878 ± 0.0144")
    print("  LGBM completo: 0.6826 ± 0.0183")
    print("  NB   completo: 0.6813 ± 0.0116")
